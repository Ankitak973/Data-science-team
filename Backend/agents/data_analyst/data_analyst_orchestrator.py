...
from Backend.agents.data_analyst.eda_agent import run_eda
from Backend.agents.data_analyst.visualization_agent import run_visualization
...
class DataAnalystOrchestrator:
    ...
    def run_visualization(self, max_plots: int = 30) -> Dict[str, Any]:
        print(f"DEBUG: DAO.run_visualization received max_plots={max_plots}")
    ...
    def run_full_pipeline(
        ...
        print(f"DEBUG: DataAnalystOrchestrator received max_plots={max_plots}")
