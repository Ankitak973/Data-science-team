...
import pandas as pd
from Backend.agents.data_analyst.data_loader_agent import DataLoader
...
class SimpleOllamaClient:
    ...
    def invoke(self, messages: list) -> Any:
        try:
            prompt = ""
            for m in messages:
                # Handle LangChain message objects or simple dicts/objects
...
def get_llm():
    try:
        ...
        # Quick health check (optional, but good for stability)
